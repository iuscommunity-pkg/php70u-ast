# IUS spec file for php70u-ast, forked from:
...
Provides: config(php-ast) = %{version}
Provides: php-ast = %{version}
Provides: php-ast%{?_isa} = %{version}

Conflicts: php-ast < %{version}
...
%changelog
* Thu May 18 2017 Ben Harper <ben.harper@rackspace.com> - 0.1.4-1.ius
